...
const MobilePartner = () => {
  ...
  const handleFirstButtonClick = async (e) => {
    ...
    try {
      ...
      if (docUpload && docUpload.data && docUpload.data.id) {
        ...
        // Handle the case where docUpload.data.id is not found
  ...
  useEffect(() => {
    ...
    if (editSubmit) {
      patchData(`offer/admin/partners/${selectedEditItem.id}/`, {
      ...
      <div className="payment-table-wrapper">
        ...
        <div className="row">
          ...
          <div className="col-md-2">
            <button
              className="btn btn-dark custom-btn w-100 fs-4"
          ...
          <div>
            ...
            <div className="col-12">
              <DropSelect
                ...
                label="Company"
                value={selectedEditItem ? selectedEditItem.company : ""}
                onChange={(value) => handleEditInputChange("company", value)}
              />
            </div>
            <div className="col-12">
              <Input
                type="text"
                placeholder="Link"
                value={selectedEditItem ? selectedEditItem.link || "" : ""}
                onChange={(value) => handleEditInputChange("link", value)}
              />
            </div>
